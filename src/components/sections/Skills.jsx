...
const Skills = () => {
    ...
    const getLevelColor = (level) => {
        const colors = {
            'Expert': 'text-[#BDFF69] bg-[#BDFF69]/20 border-[#BDFF69]/30',
    ...
    return (
        <section id='skills' className='relative py-20 bg-black overflow-hidden '>
            <div className="absolute inset-0 overflow-hidden">
                <div className='absolute top-1/4 left-0 w-96 h-96 bg-primary/10 blur-3xl opacity-50 rounded-full' />
                <div className='absolute bottom-1/4 right-0 w-96 h-96 bg-primary/10 blur-3xl opacity-50 rounded-full' />
            </div>
                ...
                <FadeIn delay={100}>
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-white/60 max-w-2xl mx-auto">
                            A Comprehensive overview of my technical skills & proficiency level
                        </p>
                    </div>
                </FadeIn>
                                        ...
                                        return (
                                            <div key={skill.id} className="space-y-2">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className={`text-xs px-2 py-2 rounded-full border ${getLevelColor(skill.level)}`}>
                                                        {skill.level}
                                                    </span>
