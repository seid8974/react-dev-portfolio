...
import { SiReact, SiNextdotjs, SiTypescript, SiTailwindcss, SiMongodb } from 'react-icons/si';
...
const About = () => {
  ...
  const skills = [
    ...
    { name: 'Node.js', icon: SiReact, color: '#339933' },
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20'>
          ...
          <div className='flex flex-col gap-12'>
            <div className="flex flex-col gap-8">
              ...
              <FadeIn delay={60}>
                <div className='inline-flex items-center gap-2.5 px-5 py-2.5 mb-8 bg-primary/10 border border-primary/30 rounded-full w-fit'>
            ...
            <FadeIn delay={400}>
              <button
                ...
                className='inline-flex items-center gap-3 bg-white hover:bg-white/90 text-black rounded-full px-8 py-6 text-base font-medium transition-all duration-300 w-fit group'
              >
          ...
          <FadeIn delay={200}>
            <div className='grid grid-cols-2 gap-4'>
              <div className='col-span-2 relative group'>
                <div className='absolute inset-0 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'>
                </div>
          ...
          <div className='flex flex-col items-center gap-8'>
            <div className='text-center'>
              ...
              <p className="text-sm text-white/60">
                Technologies I work with to build amazing production
              </p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 w-full gap-4 max-w-4xl">
