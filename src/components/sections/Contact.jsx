    ...
    return (
        <section id="contact" className="relative py-20 bg-black overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 blur-3xl opacity-30 rounded-full" />
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/20 blur-3xl opacity-30 rounded-full" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 blur-3xl opacity-30 rounded-full" />
            </div>
                    ...
                    <FadeIn delay={100}>
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                ...
                                <button
                                    type='submit'
                                    className='w-full px-6 py-3 bg-gradient-to-r from-primary/10 to-primary rounded-xl text-white hover:shadow-2xl hover:shadow-primary/30 flex items-center justify-center gap-2 group transition-all duration-300'
                                >
                            ...
                            <div className="space-y-4">
                                <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                    <div className="flex items-start gap-4">
                                        <div className="p-3 bg-gradient-to-br from-primary/20 to-primary/10 border border-primary/30 rounded-xl">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <a
                                                ...
                                                className='font-medium text-white hover:text-[#ABFF80] transition-colors'
                                            >
                                                {PERSONAL_INFO.email}
                                            </a>
                                        </div>
