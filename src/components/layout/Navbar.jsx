...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-[1000] w-full py-4 transition-all duration-300 ${isScrolled ? 'bg-black/30 backdrop-blur-lg' : 'bg-transparent'}`} style={{ transform: 'translate3d(0,0,0)' }}>
            ...
            <div className='max-w-[1328px] mx-auto px-5'>
            ...
            {/* phone */}
            <div className={`md:hidden transition-all duration-300 overflow-hidden ${isMenuOpen ? 'max-h-[530px] opacity-100' : 'max-h-0 opacity-0'}`}>
