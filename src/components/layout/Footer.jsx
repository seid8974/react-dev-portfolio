  ...
  return (
    <footer className="relative bg-black overflow-hidden border-t border-white/10">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 blur-3xl opacity-30 rounded-full" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-primary/10 blur-3xl opacity-30 rounded-full" />
      </div>
                ...
                {SOCIAL_LINKS.map((social) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer-events-none" />
                    </a>
                  ) : null;
                })}
              </div>
